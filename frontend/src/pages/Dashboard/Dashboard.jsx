...
function Company() {
  ...
  // useEffect(() => {
      axios.post("https://appli-z4ba.onrender.com/api/cards/GET", {
        user_ID: user_id
    }, {
      headers: {
...
deleteCard()
   ...
   // const user_local = JSON.parse(localStorage.getItem('user'))
    ...
    axios.patch("https://appli-z4ba.onrender.com/api/cards/Test", {
...
function Dashboard() {
 ...
 const {logout} = useLogout()
  ...
  axios.post("https://appli-z4ba.onrender.com/api/user/look", {
    Uid: Id
  })
  .then((response) => {
    console.log(response)
