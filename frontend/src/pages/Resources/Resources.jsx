      ...
      <div className="resource-content">
        <div>
          ...
          <div className="contenttext">
            ...
            <p>
              Appli offers you resources to ace that application such as resume
              templates, common technical and behavioral questions!
            </p>
          </div>
        </div>
        <div className="resource-icons">
          <ResourceBtn
            click={() => setMaterial(`resumeTemplate`)}
            title="Resume Template"
            src={resumeicon}
          />
          <ResourceBtn
            click={() => setMaterial(`technicalQuestion`)}
            title="Technical Questions"
            src={technicalicon}
          />
          <ResourceBtn
            click={() => setMaterial(`behavioralQuestion`)}
